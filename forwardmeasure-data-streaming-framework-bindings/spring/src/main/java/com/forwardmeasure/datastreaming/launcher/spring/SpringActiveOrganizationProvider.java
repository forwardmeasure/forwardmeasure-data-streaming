...
/**
 * Reads only the nested active-Organization claims from Spring Security's verified JWT. Ported from
 * forwardmeasure-entity-intelligence's own real {@code SpringActiveOrganizationProvider}, added
 ...
 *
 * <p>One deliberate change from that sibling: it throws {@link SecurityException} for an
 * unauthenticated request, since its own {@code SecurityExceptionMapper} is the 401 mapper for that
 * repo. Here, {@code SecurityException} is already reserved for {@code IngestionJobPolicy}'s own,
 ...
 * own new {@code AuthenticationRequiredExceptionMapper}.
 */
@Component
